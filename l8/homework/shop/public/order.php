    ...
    <div class="orderBody">
        ...
        <div class="formClientInfo">
            <form class="formOrder" id="formOrder" action="/my_shop/public/orderEnd.php" method="POST">
                ...
                <div class="inputGroup"><input type="text" name="phone" class="rowGoods nameFull"
                                               placeholder="Введите номер телефона"></div>
                <label for="inputDiscountCard" class="">Дисконтная карта</label>
                <input type="text" name="discountCard" id="inputDiscountCard" class=""
                ...
                <input type="text" name="desiredTime" id="inputTime"
                       placeholder="Введите желаемое время исполнения заказа">
